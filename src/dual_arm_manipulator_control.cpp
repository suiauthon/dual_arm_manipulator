#include <dual_arm_manipulator/dual_arm_manipulator_control.h>
...
DualArmManipulatorControl::DualArmManipulatorControl()
{
	...
	joint1_left_state_sub_ros_ = n_.subscribe("jointB1_controller/state", 1, &DualArmManipulatorControl::joint1_left_controller_state_cb_ros, this);
	joint2_left_state_sub_ros_ = n_.subscribe("jointB2_controller/state", 1, &DualArmManipulatorControl::joint2_left_controller_state_cb_ros, this);
	joint3_left_state_sub_ros_ = n_.subscribe("jointB3_controller/state", 1, &DualArmManipulatorControl::joint3_left_controller_state_cb_ros, this);
	joint1_right_state_sub_ros_ = n_.subscribe("jointA1_controller/state", 1, &DualArmManipulatorControl::joint1_right_controller_state_cb_ros, this);
	joint2_right_state_sub_ros_ = n_.subscribe("jointA2_controller/state", 1, &DualArmManipulatorControl::joint2_right_controller_state_cb_ros, this);
	joint3_right_state_sub_ros_ = n_.subscribe("jointA3_controller/state", 1, &DualArmManipulatorControl::joint3_right_controller_state_cb_ros, this);

	mmuav_position_sub_ros_ = n_.subscribe("odometry", 1, &DualArmManipulatorControl::mmuav_position_cb_ros, this);

	joint1_right_pub_ros_ = n_.advertise<std_msgs::Float64>("jointA1_controller/command", 1);
	joint2_right_pub_ros_ = n_.advertise<std_msgs::Float64>("jointA2_controller/command", 1);
	joint3_right_pub_ros_ = n_.advertise<std_msgs::Float64>("jointA3_controller/command", 1);

	joint1_left_pub_ros_ = n_.advertise<std_msgs::Float64>("jointB1_controller/command", 1);
	joint2_left_pub_ros_ = n_.advertise<std_msgs::Float64>("jointB2_controller/command", 1);
	joint3_left_pub_ros_ = n_.advertise<std_msgs::Float64>("jointB3_controller/command", 1);
...
void DualArmManipulatorControl::joint1_left_controller_state_cb_ros(const dynamixel_msgs::JointState &msg)
{
	left_q1_meas_ = msg.current_pos;
}

void DualArmManipulatorControl::joint2_left_controller_state_cb_ros(const dynamixel_msgs::JointState &msg)
{
	left_q2_meas_ = msg.current_pos;
}	

void DualArmManipulatorControl::joint3_left_controller_state_cb_ros(const dynamixel_msgs::JointState &msg)
{
	left_q3_meas_ = msg.current_pos;
}

void DualArmManipulatorControl::joint1_right_controller_state_cb_ros(const dynamixel_msgs::JointState &msg)
{
	right_q1_meas_ = msg.current_pos;
}

void DualArmManipulatorControl::joint2_right_controller_state_cb_ros(const dynamixel_msgs::JointState &msg)
{
	right_q2_meas_ = msg.current_pos;
}

void DualArmManipulatorControl::joint3_right_controller_state_cb_ros(const dynamixel_msgs::JointState &msg)
{
	right_q3_meas_ = msg.current_pos;
}	
